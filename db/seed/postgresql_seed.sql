...
INSERT INTO qmeta.adjustment_factor (
    security_id, trade_date, factor_forward, factor_backward, ex_right_type, announce_time, effective_time, source_id, batch_id, revision_id
) VALUES
    (1000001, '2024-01-02', 0.532100000000, 12.872300000000, 'none', '2024-01-02 18:00:00+08', '2024-01-02 18:00:00+08', 2, 2, 1),
    (1000001, '2024-01-03', 0.532100000000, 12.872300000000, 'none', '2024-01-03 18:00:00+08', '2024-01-03 18:00:00+08', 2, 2, 1),
    (1000002, '2024-01-02', 1.123400000000, 5.031200000000, 'none', '2024-01-02 18:00:00+08', '2024-01-02 18:00:00+08', 2, 2, 1),
    (1000002, '2024-01-03', 1.123400000000, 5.031200000000, 'none', '2024-01-03 18:00:00+08', '2024-01-03 18:00:00+08', 2, 2, 1),
    (1000003, '2024-01-02', 0.884200000000, 1.733100000000, 'none', '2024-01-02 18:00:00+08', '2024-01-02 18:00:00+08', 2, 2, 1)
ON CONFLICT DO NOTHING;
